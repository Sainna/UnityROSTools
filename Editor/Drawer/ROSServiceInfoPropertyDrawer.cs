...
public class ROSServiceInfoPropertyDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            Rect rectProp = new Rect(position.min.x, position.min.y + EditorGUIUtility.singleLineHeight, position.width, EditorGUIUtility.singleLineHeight);
            ...
            Type reqType = Type.GetType(messageTypeProperty.stringValue + ", Assembly-CSharp") ?? Type.GetType(messageTypeProperty.stringValue + ", Unity.Robotics.ROSTCPConnector.Messages");
            if (reqType != null)
            {
            ...
            commentProperty.stringValue = EditorGUI.TextArea(rectProp, commentProperty.stringValue, EditorStyles.helpBox);
